...
def prepare_dataloaders(root_dir="/media/nghia/DATA/FASION_polyvore/polyvore/polyvore-images/images", data_dir="./data/", batch_size=16, img_size=224, use_mean_img=True, neg_samples=True, num_workers=1, collate_fn=collate_fn):
