...
#parser.add_argument('--model_path', type=str, default="/media/nghia/Nguyen NghiaW/AIPJ_Fashion/fashion-recommendation/fashion_compatibility_mcn/baselines/attention/model_Atttrain.pth")
